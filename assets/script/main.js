...
const login_button = document.getElementById("login_button").addEventListener("click", function() {
    toggleViews(loginView)
});
const close_login = document.getElementById("close_login").addEventListener("click", function() {
    toggleViews(loginView)
});

const register_button = document.getElementById("register_button").addEventListener("click", function() {
    toggleViews(registerView)
});

const close_register = document.getElementById("close_register").addEventListener("click", function() {
    toggleViews(registerView)
});
